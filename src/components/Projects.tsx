		...
		>
			<div className="section-heading">
				<div>
					...
					<h2 id="projects-heading">Projects built with purpose</h2>
				</div>

				<p>
					A selection of responsive applications focused on reusable
					code, accessibility, performance, and clear user
					experiences.
				</p>
			</div>
			...
			<div className="projects-grid">
				...
				<article className="project-card project-card-featured">
					...
					<div className="project-content">
						...
						<p>
							...
							artwork through reusable components, dynamic artwork
							routes, centralized data, and optimized image
							delivery.
						</p>
						...
						<ul className="project-highlights">
							...
							<li>
								Semantic HTML, CSS Modules, and optimized WebP
								artwork
							</li>
				...
				<article className="project-card">
					...
					<div className="project-content">
						...
						<p>
							A responsive React application for discovering and
							browsing video games through the RAWG API, with
							searchable game data, filtering, sorting, and a
							responsive component-based interface.
						</p>

						<ul className="project-highlights">
							<li>
								Search, genre filtering, platform filtering, and
								multiple sorting options using RAWG game data
							</li>
							<li>
								Custom TypeScript hooks for reusable, type-safe
								API data fetching and request cancellation
							</li>
							<li>
								Responsive Chakra UI interface with dark mode,
								loading skeletons, platform icons, and rating
								indicators
							</li>
							<li>
								Vercel serverless API layer protecting the RAWG
								API key through server-side environment
								variables
							</li>
						</ul>
				...
				<article className="project-card">
					...
					<div className="project-content">
						<div className="project-title-row">
							...
							<span className="project-status">This Site</span>
						</div>
						<p>
							A responsive React developer portfolio designed to
							present projects, skills, certifications, and
				...
				<article className="project-card future-project">
					<div className="future-project-content">
						...
						<p>
							My next project will connect a React interface to a
							Django REST API with authentication, database-backed
							content, image management, and complete CRUD
							functionality.
						</p>
